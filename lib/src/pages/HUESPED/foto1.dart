...
class Foto1 extends StatefulWidget {
  @override
  _Foto1State createState() => _Foto1State();
}

class _Foto1State extends State<Foto1> {
          ...
          : Column(
              children: [
                ...
                Column(
                  ...
                  children: [
                    mostrarimagen1(checkindata.fotourl1),
                    SizedBox(
                      height: 10,
                    ),
                    SizedBox(
                    ...
                    mostrarimagen2(checkindata.fotourl2),
                  ],
                ),
                SizedBox(
                  height: 10,
